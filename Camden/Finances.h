...
class Finances {
	public:
		...
		void sellCoaster();			// Sell coaster for 80% of its build worth, CALLED in RollerCoaster
		...
		void chargeRideEntranceFee();		// Charge riders for entering ride; CALLED in RollerCoaster
};
